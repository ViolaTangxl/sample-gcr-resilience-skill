...
**references/common-risks-reference.md** - AWS Common Service Risk Reference Manual
...
**references/assessment-output-spec.md** - Chaos Engineering Input Specification
...
```
aws-resilience-modeling/
├── SKILL.md                                    # Skill main configuration
├── README.md                                   # This file (Chinese)
├── README_EN.md                                # This file (English)
├── references/
│   ├── resilience-framework.md                 # Detailed resilience analysis reference framework
│   ├── common-risks-reference.md               # AWS common service risk manual
│   ├── assessment-output-spec.md               # Chaos engineering input specification
│   ├── report-generation.md                    # Report generation process and code
│   ├── HTML-TEMPLATE-USAGE.md                  # HTML template usage guide
